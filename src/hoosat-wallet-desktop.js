import { html, css, FlowFormat, i18n, T } from "./hoosat-wallet-ui.js";
import { HoosatWalletMobile } from "./hoosat-wallet-mobile.js";

export class HoosatWalletDesktop extends HoosatWalletMobile {
  ...
  static get styles() {
    return [
      HoosatWalletMobile.styles,
      css`
        :host {
          overflow: hidden;
        }
        .container {
          padding: var(--hoosat-wallet-container-padding, 15px);
          position: relative;
          flex: 1;
          overflow: auto;
        }
        ...
        .wallet-warning {
          ...
          padding: 10px;
          text-align: center;
          background-color: var(--hoosat-wallet-warning-bg, #fdf8e4);
        }
        .heading {
        ...
        .right-area {
          ...
          margin-right: 20px;
          max-width: 750px;
          height: var(--hoosat-wallet-right-area-height, calc(100vh - 122px));
          display: flex;
        ...
        .top-menu {
          display: flex;
          align-items: center;
          position: var(--hoosat-wallet-top-menu-position, absolute);
          right: var(--hoosat-wallet-top-menu-right, 20px);
          top: var(--hoosat-wallet-top-menu-top, -4px);
          z-index: 2;
        ...
        .header {
          border-bottom: var(
            --hoosat-wallet-header-border-bottom,
            --2px solid var(--hoosat-wallet-tab-border-top-color, var(--flow-primary-color))
          );
        }
      `,
    ];
      ...
      <div class="container">
        <div class="body">
          <div class="left-area">
            ...
            ${this.renderBalance()} ${this.renderAddress()} ${this.renderQRAndSendBtn()}
          </div>
          <div class="right-area">${super.render()}</div>
        </div>
      </div>
    `;
  }
  renderHeaderBar(isDesktop = false) {
    if (isDesktop) return super.renderHeaderBar();
    return "";
  }
  renderAllTX() {
    return html` ${this.renderTxNotifications()} ${super.renderAllTX()}`;
  }
  ...
  renderAddress() {
    ...
    return html` <div class="address-badge">
      ...
      <div class="address-holder">
        <textarea
          ...
          .value="${this.receiveAddress || ""}"
        ></textarea>
        <fa-icon
          ?hidden=${!this.receiveAddress}
          class="copy-address"
    ...
    return html`
      <div class="qr-code-holder">
        ...
        <div class="buttons-holder">
          ...
          <flow-btn primary ?hidden=${this.hideQRScanner} @click="${this.showSendDialogWithQrScanner}" i18n
            >Scan QR code</flow-btn
          >
        </div>
      </div>
      <div class="status">
